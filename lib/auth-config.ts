 ...
 * 
 * IMPORTANT: This file should be auto-generated by running:
 * npm run setup:memberstack
 * 
 * If you haven't set up Memberstack yet, the app will use a default
 * configuration that allows basic authentication without plan restrictions.
 */
